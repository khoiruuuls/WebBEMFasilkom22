<div class="card">
  ...
  <div class="card-body">
    <div class="row mb-md-3 mb-5 mb-sm-5">
      <div class="col-md-6 mb-md-0 mb-4 mb-sm-4">
        ...
        <div class="row">
          <div class="col-md-3 mb-md-2 mb-0 mb-sm-0">
            No. Telepon Ketua Tim <span class="d-md-none d-inline d-sm-inline">:</span>
          </div>
          <div class="col-md-9 mb-md-0 mb-3 mb-sm-3">
      ...
      <div class="col-md-6">
        ...
        <a id="popBukti">
          <img src="{{ asset('storage/' . $tim->path_bukti_pembayaran) }}" alt="{{ $tim->nama_tim }}" id="bukti" class="img-fluid my-2 img-fcup" style="width:100%; max-width:100px">
        </a>
      </div>
    </div>
