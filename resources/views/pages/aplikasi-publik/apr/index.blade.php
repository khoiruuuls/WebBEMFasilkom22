                            ...
                            <div class="col-md-4">
                                <div class="input-group flex-nowrap">
                                    <input type="text" class="form-control search-box" name="q"
                                        ...
                                        placeholder="Cari advokasi">
                                    <button type="submit" class="btn btn-primary float-right btn-show"><i
                                ...
                                <div class="row">
                                    <div class="col-md">
                                        ...
                                        @elseif ($report->statusLabel() == 'Diproses')
                                            <span
                                                class="badge rounded-pill bg-warning p-2 float-end border-0">Diproses</span>
                                        @elseif ($report->statusLabel() == 'Selesai')
                                            <span
                                                class="badge rounded-pill bg-success p-2 float-end border-0">Selesai</span>
