  ...
  <section id="content-bem" class="content-bem mt-5">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center mt-5 mb-5">
        <div class="col-md-4">
          <img src="{{ url('frontend/assets/img/foto_profile/foto_minbat/senbud2022/senbud.png')}}" alt="" width="400px" height="230px" class="img-thumbnail">
        </div>
        <div class="col-md-4">
      ...
      <div class="row mt-5 justify-content-center text-center mt-5">
          ...
          <div class="col-md-3">
            <img src="{{ url('frontend/assets/img/foto_profile/foto_minbat/senbud2022/giosenbud.png')}}" alt="" width="400px" height="230px" class="img-thumbnail">
            <div class="card">
              <div class="card-body">
      ...
      <div class="row justify-content-center anggota">
        ...
        <div class="row justify-content-center text-center align-text-bottom mb-5">
            ...
            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_minbat/senbud2022/krissenbud.png')}}" alt="" width="400px" height="230px" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
                  <h4>Anggota</h4>
                  <p>Kris Adiwinata</p>
            ...
            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_minbat/senbud2022/devisenbud.png')}}" alt="" width="400px" height="230px" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
                  <h4>Anggota</h4>
                  <p>Devi Fitriani Maulana</p>
                </div>
              </div>
            </div>

            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_minbat/senbud2022/nurisenbud.png')}}" alt="" width="400px" height="230px" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
                  <h4>Anggota</h4>
                  <p>Andriani Nurian</p>
