  ...
  <section id="content-bem" class="content-bem mt-5">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center mt-5 mb-5">
        <div class="col-md-4">
          <img src="{{ url('frontend/assets/img/foto_profile/foto_minbat/olahraga2022/olahraga.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
        </div>
        <div class="col-md-4">
        ...
        <div class="row mt-5 justify-content-center text-center mt-5">
            ...
            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_minbat/olahraga2022/deoolahraga.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
        ...
        <div class="row justify-content-center anggota">
          ...
          <div class="row justify-content-center text-center align-text-bottom mb-5">
              ...
              <div class="col-md-3">
                <img src="{{ url('frontend/assets/img/foto_profile/foto_minbat/olahraga2022/anisaolahraga.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
                <div class="card">
                  <div class="card-body">
                    <h4>Anggota</h4>
                    <p>Anisa Nur Hasanah</p>
                  </div>
                </div>
              </div>
              
              <div class="col-md-3">
                <img src="{{ url('frontend/assets/img/foto_profile/foto_minbat/olahraga2022/arfanolahraga.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
                <div class="card">
                  <div class="card-body">
                    <h4>Anggota</h4>
                    <p>Arfan Ryo Darmawan</p>
                  </div>
                </div>
              </div>
