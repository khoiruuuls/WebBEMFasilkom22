  ...
  <section id="content-bem" class="content-bem mt-5">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center mt-5 mb-5">
        <div class="col-md-4">
          <img src="{{ url('frontend/assets/img/foto_profile/foto_kominfo/media2022/media.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
        </div>
        <div class="col-md-4">
      ...
      <div class="row justify-content-center text-center mt-5">
          <div class="col-md-3">
            <img src="{{ url('frontend/assets/img/foto_profile/foto_kominfo/media2022/novantomedia.png') }}" alt="" class="img-thumbnail">
            <div class="card">
              <div class="card-body">
      ...
      <div class="row justify-content-center anggota">
        ...
        <div class="row justify-content-center text-center align-text-bottom mb-5">
            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_kominfo/media2022/adityamedia.png') }}" alt="" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
                  <h4>Anggota</h4>
                  <p>Aditya Pramudya</p>
            ...
            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_kominfo/media2022/naufalmedia.png') }}" alt="" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
                  <h4>Anggota</h4>
            ...
            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_kominfo/media2022/irnamedia.png') }}" alt="" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
                  <h4>Anggota</h4>
