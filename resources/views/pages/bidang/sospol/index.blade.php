    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center mt-5 mb-5">
        <div class="col-md-4 mb-5">
          <img src="{{ url('frontend/assets/img/foto_profile/foto_sospol/sospol.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
        </div>
        <div class="col-md-6">
      ...
      <div class="row mt-5 justify-content-center text-center m-5">
          ...
          <div class="col-md-3">
            <img src="{{ url('frontend/assets/img/foto_profile/foto_sospol/sultan.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
            <div class="card">
              <div class="card-body">
