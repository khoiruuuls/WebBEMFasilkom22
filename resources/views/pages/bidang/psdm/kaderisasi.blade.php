  ...
  <section id="content-bem" class="content-bem mt-5">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center mt-5 mb-5">
        <div class="col-md-4">
          <img src="{{ url('frontend/assets/img/foto_profile/foto_psdm/kaderisasi2022/kaderisasi.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
        </div>
        <div class="col-md-4">
      ...
      <div class="row mt-5 justify-content-center text-center mt-5">
          ...
          <div class="col-md-3">
            <img src="{{ url('frontend/assets/img/foto_profile/foto_psdm/kaderisasi2022/agkaderisasi.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
            <div class="card">
              <div class="card-body">
                <h4>Koordinator Departemen</h4>
                <p>Agnia Virli Rosdianty</p>
              </div>
            </div>
          </div>
      ...
      <div class="row justify-content-center anggota">
        ...
        <div class="row justify-content-center text-center align-text-bottom mb-5">
            ...
            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_psdm/kaderisasi2022/alvikaderisasi.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
                  <h4>Anggota</h4>
                  <p>Alvi Yuniar</p>
            ...
            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_psdm/kaderisasi2022/sidqihkaderisasi.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
                  <h4>Anggota</h4>
                  <p>Muhamad Sidqih Arhinza Juliantara</p>
                </div>
              </div>
            </div>

            <div class="col-md-3">
              <img src="{{ url('frontend/assets/img/foto_profile/foto_psdm/kaderisasi2022/alpinkaderisasi.png') }}" alt="" width="400px" height="230px" class="img-thumbnail">
              <div class="card">
                <div class="card-body">
                  <h4>Anggota</h4>
                  <p>Alpin Apriliansyah Mohsa</p>
                </div>
              </div>
            </div>
