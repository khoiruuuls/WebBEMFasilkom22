...
<script src="{{ asset('backend/assets/vendor/bootstrap-daterangepicker/js/daterangepicker.js') }}"></script>
<script src="{{ asset('backend/assets/vendor/summernote/js/summernote-bs4.js') }}"></script>
<script src="{{ asset('backend/assets/vendor/selectric/public/jquery.selectric.min.js') }}"></script>
