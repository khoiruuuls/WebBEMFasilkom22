...
<!-- CSS Libraries -->
<link rel="stylesheet" href="{{ asset('backend/assets/vendor/selectric/public/selectric.css') }}">
<link rel="stylesheet" href="{{ asset('backend/assets/vendor/bootstrap-timepicker/css/bootstrap-timepicker.min.css') }}">
<link rel="stylesheet" href="{{ asset('backend/assets/vendor/bootstrap-daterangepicker/css/daterangepicker.css') }}">
