...
--
-- Host: localhost:3306
-- Generation Time: Jun 24, 2022 at 07:21 PM
...
--
-- Database: `bemfasi1_arthasastra2021`
--
...
(1, 1, 'Welcoming Maba', 'welcoming-maba', '<p>Welcoming Maba merupakan sebuah kegiatan penyambutan mahasiswa baru yang berisi kegiatan-kegiatan seperti perkenalan fakultas dan prodi pada Fakultas Ilmu Komputer.</p>', 'Alvi Yuniar', '0', 0, '3', '2021-07-07 15:38:13', '2022-06-23 13:27:49'),
...
(4, 1, 'BEM FASILKOM Academy', 'bem-fasilkom-academy', '<p>Kegiatan ini bertujuan untuk menciptakan eksekutif muda dari para mahasiswa baru dan memberikan gambaran mengenai tugas dan peranan BEM Fakultas. </p>', 'Muhamad Sidqih Arhinza Juliantara', '0', 0, '3', '2021-07-07 15:39:33', '2022-06-23 13:31:53'),
...
(35, 11, 'Pemeliharaan Website', 'pemeliharaan-website', '<p>Pemeliharaan website merupakan proker IT Support yang menangani tentang\r\nkeamanan data dan melakukan peningkatan serta pengembangan terhadap sistem\r\nwebsite.</p>', 'Anandito Rafi Putra', '700000', 0, '1', '2021-07-07 16:00:10', '2022-06-23 13:31:53'),
(36, 11, 'Open Project', 'open-project', '<p>Open project merupakan program kerja dari dept.PTI yang bertujuan merealisasikan platform hasil request dari berbagai departemen pada Internal BEM Fasilkom.</p>', 'Ahmad Nursidik Dinar', '0', 0, '1', '2021-07-07 16:00:27', '2022-06-23 13:31:53'),
(37, 11, 'LPJ Online', 'lpj-online', '<p>LPJ Online merupakan sebuah media alternatif dari Laporan Pertanggung Jawaban yang berbentuk hardfile (kertas) yang diringkas dan dicantumkan kedalam website BEM Fasilkom Unsika. </p> ', 'Fathan Pebrilliestyo Ridwan', '100000', 0, '2', '2021-07-07 16:00:43', '2022-06-23 13:31:53'),
...
(1, 'Info Pengambilan Almamater Mahasiswa/i 2020', 'info-pengambilan-almamater-mahasiswai-2020', '<p>-</p>', '<p>-</p>', 2, '2021-07-09 12:20:34', '2021-07-09 12:20:34');
...
(2, 'Humas', 'web', '2021-07-14 08:23:21', '2022-03-10 13:33:35'),
...
(3, 20, 'nida tsuroya sholahuddin', 8, '2021-07-23 03:06:13', '2022-06-13 10:46:01'),
...
(27, 2, 'Alia Fadilah', 1, '2021-07-29 09:01:15', '2021-07-29 09:01:15'),
...
(1, 'Admin', 'admin.cs@unsika.ac.id', '2021-07-14 08:23:21', '$2y$10$jNcvylUPToErv94WIJ6p5u35nmNrs8xUZke0/Zg23k1WIbHcsKTDu', NULL, NULL, NULL, NULL, NULL, 'ZRZi18qBURtS0SptAQPwMai28kkEOCNAxGwvLeF9qZO8VJrxdcDBWlhNnVjn', '2021-07-14 08:23:21', '2022-06-24 11:52:21'),
(2, 'Humas', 'humas.cs@unsika.ac.id', '2021-07-14 08:23:21', '$2y$10$MDzRls5B.WDB9zVsKZjhuOTwwp0wlZiW.Z4h/iaz/vbgAfD.kXDES', NULL, NULL, NULL, NULL, NULL, 'CP2TXcmK82ouTCufoZiSYc19yANT0ioUVJ08hY85eUf8pe0gg9U8MOy9Hx7K', '2021-07-14 08:23:21', '2021-07-14 10:55:49'),
...
(5, 'FENNY RAHMAYANI', '1910631170020@student.unsika.ac.id', NULL, '$2y$10$kzq9yeIrpiBIMgBCzh7En.jeOTF0j4HZwmXhvDozOvARC0RacYM56', NULL, NULL, '1910631170020', 'S1 Teknik Informatika', '2019', NULL, '2022-05-23 12:38:25', '2022-05-23 12:38:25'),
(6, 'halo', 'hahah@gmail.com', NULL, '$2y$10$tSzfGMQb7In7Ebo0qvxcwe8c6VzydFaoIA9lj1joiFyjDvUeiorxi', NULL, NULL, '191976554321', 'S1 Hubungan Internasional', '2015', NULL, '2022-06-03 09:11:11', '2022-06-03 09:11:11'),
(7, 'Gebby Dwi Putri Haryanto', 'gebby.dwi19044@student.unsika.ac.id', NULL, '$2y$10$xLCHmHZII6gqvRR8.MCSDuoOQT.WNh2RKM5SczFwa5Rs67F7orSSS', NULL, NULL, '1910631250044', 'S1 Sistem Informasi', '2019', NULL, '2022-06-14 06:02:11', '2022-06-14 06:02:11'),
(8, 'AHMAD NURSIDIK DINAR', 'Dinardevil@gmail.com', NULL, '$2y$10$zh3Pazu39bGvKpd80Z7dGeJojhOOxk3f3Hu9DqLn4Y6UpadVJdDqi', NULL, NULL, '1910631170157', 'S1 Teknik Informatika', '2019', NULL, '2022-06-14 06:04:46', '2022-06-14 06:04:46'),
(10, 'minbat', 'minbat.cs@unsika.ac.id', NULL, '$2y$10$RofQyKkUfszgiXCK2.0FWe1BevY9/mJmbBYYOAhmcFCc5szPo3Ooq', NULL, NULL, NULL, NULL, NULL, NULL, '2022-06-14 06:52:04', '2022-06-24 12:04:50');
...
--
ALTER TABLE `anggota`
  ADD CONSTRAINT `anggota_id_proposal_foreign` FOREIGN KEY (`id_proposal`) REFERENCES `proposal` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `anggota_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `pengurus`
  ADD CONSTRAINT `pengurus_id_bidang_foreign` FOREIGN KEY (`id_bidang`) REFERENCES `bidang` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `pengurus_id_departemen_foreign` FOREIGN KEY (`id_departemen`) REFERENCES `departemen` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_cadangan_dota`
--
ALTER TABLE `peserta_cadangan_dota`
  ADD CONSTRAINT `peserta_cadangan_dota_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_dota` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_cadangan_ml_putri`
--
ALTER TABLE `peserta_cadangan_ml_putri`
  ADD CONSTRAINT `peserta_cadangan_ml_putri_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_ml_putri` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_cadangan_ml_umum`
--
ALTER TABLE `peserta_cadangan_ml_umum`
  ADD CONSTRAINT `peserta_cadangan_ml_umum_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_ml_umum` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_cadangan_pubg`
--
ALTER TABLE `peserta_cadangan_pubg`
  ADD CONSTRAINT `peserta_cadangan_pubg_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_pubg` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_cadangan_valorant`
--
ALTER TABLE `peserta_cadangan_valorant`
  ADD CONSTRAINT `peserta_cadangan_valorant_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_valorant` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_catur_putra`
--
ALTER TABLE `peserta_catur_putra`
  ADD CONSTRAINT `peserta_catur_putra_id_turnamen_foreign` FOREIGN KEY (`id_turnamen`) REFERENCES `turnamen` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_catur_putri`
--
ALTER TABLE `peserta_catur_putri`
  ADD CONSTRAINT `peserta_catur_putri_id_turnamen_foreign` FOREIGN KEY (`id_turnamen`) REFERENCES `turnamen` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_dota`
--
ALTER TABLE `peserta_dota`
  ADD CONSTRAINT `peserta_dota_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_dota` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_ml_putri`
--
ALTER TABLE `peserta_ml_putri`
  ADD CONSTRAINT `peserta_ml_putri_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_ml_putri` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_ml_umum`
--
ALTER TABLE `peserta_ml_umum`
  ADD CONSTRAINT `peserta_ml_umum_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_ml_umum` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_pubg`
--
ALTER TABLE `peserta_pubg`
  ADD CONSTRAINT `peserta_pubg_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_pubg` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `peserta_valorant`
--
ALTER TABLE `peserta_valorant`
  ADD CONSTRAINT `peserta_valorant_id_tim_foreign` FOREIGN KEY (`id_tim`) REFERENCES `tim_valorant` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `proposal`
--
ALTER TABLE `proposal`
  ADD CONSTRAINT `proposal_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `tim_dota`
--
ALTER TABLE `tim_dota`
  ADD CONSTRAINT `tim_dota_id_turnamen_foreign` FOREIGN KEY (`id_turnamen`) REFERENCES `turnamen` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tim_ml_putri`
--
ALTER TABLE `tim_ml_putri`
  ADD CONSTRAINT `tim_ml_putri_id_turnamen_foreign` FOREIGN KEY (`id_turnamen`) REFERENCES `turnamen` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tim_ml_umum`
--
ALTER TABLE `tim_ml_umum`
  ADD CONSTRAINT `tim_ml_umum_id_turnamen_foreign` FOREIGN KEY (`id_turnamen`) REFERENCES `turnamen` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tim_pb`
--
ALTER TABLE `tim_pb`
  ADD CONSTRAINT `tim_pb_id_turnamen_foreign` FOREIGN KEY (`id_turnamen`) REFERENCES `turnamen` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tim_pubg`
--
ALTER TABLE `tim_pubg`
  ADD CONSTRAINT `tim_pubg_id_turnamen_foreign` FOREIGN KEY (`id_turnamen`) REFERENCES `turnamen` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tim_valorant`
--
ALTER TABLE `tim_valorant`
  ADD CONSTRAINT `tim_valorant_id_turnamen_foreign` FOREIGN KEY (`id_turnamen`) REFERENCES `turnamen` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tugas_individu_maba`
--
ALTER TABLE `tugas_individu_maba`
  ADD CONSTRAINT `tugas_individu_maba_id_maba_foreign` FOREIGN KEY (`id_maba`) REFERENCES `maba` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tugas_kelompok_maba`
--
ALTER TABLE `tugas_kelompok_maba`
  ADD CONSTRAINT `tugas_kelompok_maba_id_maba_foreign` FOREIGN KEY (`id_maba`) REFERENCES `maba` (`id`) ON DELETE CASCADE;
COMMIT;
