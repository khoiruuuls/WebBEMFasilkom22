...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"Programming Language!": [["golang", "octave", "scilab", "applescript"],
			["java", "pearl", "scar", "cocol"], 
			["groovy", "ruby", "turing", "dylan"],
			["javascript", "rust", "unicon", "python"],
			["matlab", "scala", "beta", "snowball"]],

		"Framework JavaScript and PHP!": [["angularjs", "reactjs", "laravel", "slim"],
			["vuejs", "emberjs", "cakephp", "lumen"],
			["nodejs", "backbonejs", "symfony", "phalcon"],
			["nextjs", "mithril", "codeigniter", "aura"],
			["expressjs", "polymer", "seagull", "fuelphp"]],

		"Framework and Library Python!": [["django", "bottle", "pandas", "matplotlib"],
			["flask", "pyramid", "numpy", "seaborn"],
			["tornado", "cherrypy", "scipy", "tensorflow"],
			["dash", "giotto", "scikit learn", "keras"],
			["falcon", "sanic", "nltk", "statsmodels"]],

		"Computer Science Job Title!": [["programmer", "game developer", "software management", "ux designer"],
			["web designer", "network developer", "software modeling ", "data analyst"],
			["web developer", "network security", "software tester", "data scientist"],
			["it staff", "cracker", "it support", "data engineer"],
			["game tester", "software developer", "ui designer", "database administrator"]],

		"Branch of Computer Science!": [["artificial intelligence", "web programming", "computer network", "ui design"],
			["data science", "mobile programming", "ux design", "programming algorithm"],
			["machine learning", "desktop programming", "software engineering", "system security"],
			["data analysis", "cloud computing", "operating system", "bussiness intelligence"],
			["data analytics", "blockchain", "computer architecture", "digital forensics"]]
